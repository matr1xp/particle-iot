...
A Particle project named Home

## Welcome to your project!

Every new Particle project is composed of 3 important elements that you'll see have been created in your project directory for Home.
...
- Any libraries stored under `lib/<libraryname>/src`# particle-iot
